      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
          ...
          <td>
            <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                ...
                <td nowrap="nowrap">
                  <?php print $store_address; ?><br /><?php print $store_phone; ?><br/><?php print $store_email; ?>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php print t('Thanks for your order (ဝယ္ယူမႈအတြက္ေက်းဇူးအထူးတင္ရွိပါသည္) , !order_first_name!', array('!order_first_name' => $order_first_name)); 
			 ?></b></p>
            ...
            <p><b><?php //print t('Want to manage your order online?'); 
			print t('သင္၏အေကာင့္အားဝင္ေရာက္ၾကည့္ရႈရန္!!'); ?></b><br />
			...
			print t('ဤအေကာင့္အသစ္အားအသံုးျပဳ၍ သင္၏မွာယူထားမႈအေျခေနကိုျပန္လည္ၾကည့္ရႈႏိုင္ရန္ !store_link ၏ menu တြင္ရွိေသာ "My account" ကိုႏွိပ္၍ေသာ္လည္းေကာင္း ေအာက္ေဖာ္ျပပါ link အားႏွိပ္၍ login ဝင္ေရာက္ၾကည့္ရႈႏိုင္ပါသည္။', array('!store_link' => $store_link)); ?>
            <br /><br /><?php print $site_login_link; ?></p>
            <?php endif; ?>

            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#289DCC" style="color: white;">
                  <b><?php print t('Purchasing Information (ဝယ်ယူထားမှုနှင့်ဆိုင်သော အချက်အလက်များ):'); ?></b>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
              ...
              <tr>
                <td colspan="2" bgcolor="#289DCC" style="color: white;">
                  <b><?php print t('Order Summary (မှာယူထားသည့်ပစ္စည်းများစာရင်း):'); ?></b>
                </td>
              </tr>
